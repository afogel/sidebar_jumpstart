...
sidebar jumpstart is a Rails template, so you pass it in as an option when creating a new app.
...
```bash
rails new myapp -d postgresql -m https://raw.githubusercontent.com/afogel/sidebar_jumpstart/main/template.rb
```
